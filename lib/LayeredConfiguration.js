...
class LayeredConfiguration {
    ...
    /**
     * @private
     * Traverses a configuration object recursively and returns the element at the position given in the path array
     *
     ...
     */
    getConfigurationNode(pathArray, currentContext, createNonExisting) {
